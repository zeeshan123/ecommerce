...
class Tejar_Billboard_Block_Adminhtml_Unit_Edit_Tab_Form extends Itactica_Billboard_Block_Adminhtml_Unit_Edit_Tab_Form
{
     protected function _prepareForm(){
        ...
        $fieldset2->addField('alt_first', 'text', array(
		 ...
		 $fieldset2->addField('description_first', 'textarea', array(
            'label' => Mage::helper('itactica_billboard')->__('Description'),
            'name'  => 'description_first',
            'note'  => Mage::helper('itactica_billboard')->__('Enter an Description for the image'),
        ));
        ...
        $fieldset3->addField('alt_second', 'text', array(
		 ...
		 $fieldset3->addField('description_second', 'textarea', array(
            'label' => Mage::helper('itactica_billboard')->__('Description'),
        ...
        $fieldset4->addField('alt_third', 'text', array(
		 ...
		 $fieldset4->addField('description_third', 'textarea', array(
            'label' => Mage::helper('itactica_billboard')->__('Description'),
        ...
        $fieldset5->addField('alt_fourth', 'text', array(
		 ...
		 $fieldset5->addField('description_fourth', 'textarea', array(
            'label' => Mage::helper('itactica_billboard')->__('Description'),
	   ...
	   $fieldset6 = $form->addFieldset('unit_form6', array('legend'=>Mage::helper('itactica_billboard')->__('Image #5')));
		$fieldset6->addType('image', Mage::getConfig()->getBlockClassName('itactica_billboard/adminhtml_unit_helper_image'));

        $fieldset6->addField('image_large_fifth', 'image', array(
            'label' => Mage::helper('itactica_billboard')->__('Image for Large Screens'),
            'name'  => 'image_large_fifth',
            'note'  => Mage::helper('itactica_billboard')->__('Recommended image width: 1067px'),
        ));

        $fieldset6->addField('image_medium_fifth', 'image', array(
            'label' => Mage::helper('itactica_billboard')->__('Optimized Image for Medium and Small Screens'),
            'name'  => 'image_medium_fifth',
            'note'  => Mage::helper('itactica_billboard')->__('Recommended image width: 640px'),
        ));

        $fieldset6->addField('alt_fifth', 'text', array(
            'label' => Mage::helper('itactica_billboard')->__('Alt Attribute Text'),
            'name'  => 'alt_fifth',
            'note'  => Mage::helper('itactica_billboard')->__('Enter an alternate text for the image'),
        ));

		 $fieldset6->addField('description_fifth', 'textarea', array(
            'label' => Mage::helper('itactica_billboard')->__('Description'),
            'name'  => 'description_fifth',
            'note'  => Mage::helper('itactica_billboard')->__('Enter an Description for the image'),
        ));
		
        $fieldset6->addField('link_fifth', 'text', array(
            'label' => Mage::helper('itactica_billboard')->__('Link'),
            'name'  => 'link_fifth',
            'note'  => $this->__('URL to redirect when image is clicked. Could be an absolute or relative path. Leave empty for no link'),
        ));
