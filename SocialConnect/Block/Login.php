...
class Tejar_SocialConnect_Block_Login extends Mage_Core_Block_Template
{
    ...
    protected function _construct() {
        ...
        Mage::register('tejar_socialconnect_button_text', $this->__('Login'), true);

        $this->setTemplate('tejar/socialconnect/login.phtml');
    }
