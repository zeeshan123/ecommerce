...
class Tejar_SocialConnect_Block_Checkout extends Mage_Core_Block_Template
{
    ...
    protected function _construct() {
        ...
        Mage::register('tejar_socialconnect_button_text', $this->__('Continue'), true);

        $this->setTemplate('tejar/socialconnect/checkout.phtml');
    }
