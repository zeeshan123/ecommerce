...
class Tejar_SocialConnect_Block_Google_Account extends Mage_Core_Block_Template
{
    /**
     *
    ...
    protected function _construct() {
        ...
        $this->setTemplate('tejar/socialconnect/google/account.phtml');
    ...
    protected function _getPicture()
    {
        if($this->userInfo->getPicture()) {
            return Mage::helper('tejar_socialconnect/google')
