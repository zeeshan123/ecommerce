...
class Tejar_SocialConnect_Block_Linkedin_Account extends Mage_Core_Block_Template
{
    /**
     *
    ...
    protected function _construct() {
        ...
        $this->setTemplate('tejar/socialconnect/linkedin/account.phtml');
    }
    ...
    protected function _getPicture()
    {
        if($this->userInfo->getPictureUrl()) {
            return Mage::helper('tejar_socialconnect/linkedin')
