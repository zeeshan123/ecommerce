...
class Tejar_SocialConnect_Block_Facebook_Account extends Mage_Core_Block_Template
{
    /**
     *
    ...
    protected function _construct() {
        ...
        $this->setTemplate('tejar/socialconnect/facebook/account.phtml');
    }
    ...
    protected function _getPicture()
    {
        if($this->userInfo->getPicture()) {
            return Mage::helper('tejar_socialconnect/facebook')
