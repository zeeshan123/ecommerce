...
class Tejar_SocialConnect_Model_Linkedin_Info_User extends Tejar_SocialConnect_Model_Linkedin_Info
{
     ...
     * @return Tejar_SocialConnect_Model_Linkedin_Userinfo
     */
    public function load($id = null)
    {
        ...
        if(!($socialconnectLid = $this->customer->getTejarSocialconnectLid()) ||
                !($socialconnectLtoken = $this->customer->getTejarSocialconnectLtoken())) {
            return $this;
        }
    ...
    protected function _onException($e) {
        ...
        $helper = Mage::helper('tejar_socialconnect/linkedin');
        /* @var $helper Tejar_SocialConnect_Helper_Linkedin */
