...
class Tejar_SocialConnect_Helper_Linkedin extends Mage_Core_Helper_Abstract
{
    ...
    public function disconnect(Mage_Customer_Model_Customer $customer) {
        ...
        $pictureFilename = Mage::getBaseDir(Mage_Core_Model_Store::URL_TYPE_MEDIA)
                ...
                .'linkedin'
                .DS
                .$customer->getTejarSocialconnectLid();

        if(file_exists($pictureFilename)) {
            @unlink($pictureFilename);
        }

        $customer->setTejarSocialconnectLid(null)
        ->setTejarSocialconnectLtoken(null)
        ->save();
    }
    ...
    public function connectByLinkedinId(
            ...
            $token)
    {
        $customer->setTejarSocialconnectLid($linkedinId)
                ->setTejarSocialconnectLtoken($token)
                ->save();
            ...
            $token)
    {
        ...
        $customer->setWebsiteId(Mage::app()->getWebsite()->getId())
                ...
                ->setTejarSocialconnectLid($linkedinId)
                ->setTejarSocialconnectLtoken($token)
    ...
    public function getCustomersByLinkedinId($linkedinId)
    {
        ...
        $collection = $customer->getCollection()
            ->addAttributeToSelect('tejar_socialconnect_ltoken')
            ->addAttributeToFilter('tejar_socialconnect_lid', $linkedinId)
            ->setPageSize(1);
