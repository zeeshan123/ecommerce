...
class Tejar_CustomFilters_Model_Layer_Filter_Category extends Mage_Catalog_Model_Layer_Filter_Category
{
    /**
    ...
    protected function _getItemsData()
    {
        ...
        if ($data === null) {
            ...
            if (!Mage::app()->getRequest()->isAjax()) {
                Mage::getSingleton('catalog/session')->setResetFiltersUrl($category->getUrl());
            }
