...
class Tejar_ObservPricing_Adminhtml_Catalog_Product_Action_AttributeController extends Mage_Adminhtml_Catalog_Product_Action_AttributeController
{
    /**
...
//========================================= ZEE CODE =================================================//
			//--- Fire a Custom Event....
			Mage::dispatchEvent('catalog_product_massupdate_attribute_custom', array('products'=>$this->_getHelper()->getProductIds()));
//========================================= ZEE CODE =================================================//
